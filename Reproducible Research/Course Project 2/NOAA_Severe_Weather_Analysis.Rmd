...
##Synopsis
This report is an examination and analysis of the NOAA data from 1950 to November 2011.  The recordset used contains 902297 observations of 37 variables.  The variables chosen in this analysis for examination are EVTYPE, FATALITIES, INJURIES, CROPDMG and PROPDMG to determine the impact that each event had and determine which were the two worst impacting event types.
